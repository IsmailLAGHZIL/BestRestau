...
<head>
  ...
  <!-- 
    - primary meta tags
  -->
  <title>Best Restau - Amazing & Delicious Food</title>
  <meta name="title" content="Best Restau - Amazing & Delicious Food">
  <meta name="description" content="This is a Restaurant html template made by codewithsadee">

  <!-- 
    - faviconm
  -->
  <link rel="shortcut icon" href="{{asset('./images/logo-best-restau.png')}}" type="./images/svg+xml">
  ...
  <!-- 
    - preload images
  -->
  <link rel="preload" as="image" href="{{asset('hero-slider-1.jpg')}}">
  <link rel="preload" as="image" href="{{asset('hero-slider-2')}}.jpg">
  <link rel="preload" as="image" href="{{asset('hero-slider-3.jpg')}}">
...
<body id="top">
  ...
  <div class="topbar">
    <div class="container">
      ...
      <address class="topbar-item">
        ...
        <span class="span">
          Restaurant St, Delicious City, Calais 62100, FR
        </span>
      </address>
      ...
      <a href="tel:++33602541348" class="topbar-item link">
        <div class="icon">
          <ion-icon name="call-outline" aria-hidden="true"></ion-icon>
        </div>

        <span class="span">+336 02 54 13 48 </span>
      </a>

      <div class="separator"></div>

      <a href="mailto:contact@bestrestau.com" class="topbar-item link">
        <div class="icon">
          <ion-icon name="mail-outline" aria-hidden="true"></ion-icon>
        </div>

        <span class="span">contact@bestrestau.com</span>
      </a>
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="{{asset('./images/logo-best-restau.png')}}" width="160" height="50" alt="Best - Restau - Home">
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <div class="text-center">
          ...
          <p class="body-4 navbar-text">Open at: 9:30 - 00:00</p>

          <a href="mailto:contact@bestrestau.com" class="body-4 sidebar-link">contact@bestrestau.com</a>

          <div class="separator"></div>

          <p class="contact-label"> Contact Request </p>
    ...
    <article>
      ...
      <section class="section about text-center" aria-labelledby="about-label" id="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <a href="tel:+804001234567" class="body-1 contact-number hover-underline">+336 02 13 54 48</a>
      ...
      <section class="section testi text-center has-bg-image"
        ...
        <div class="container">
          ...
          <div class="profile">
            <img src="{{asset('./images/testi-avatar1.jpg')}}" width="100" height="100" loading="lazy" alt="Sam Jhonson"
              class="img">

            <p class="label-2 profile-name"> Ismail LAGHZIL </p>
          </div>
          ...
          <div class="form reservation-form bg-black-10">
            ...
            <form action="" class="form-left">
              ...
              <p class="form-text text-center">
                Booking request <a href="tel:+33602541348" class="link">+33-602 54 13 48</a>
            ...
            <div class="form-right text-center" style="background-image: url('{{asset('./images/form-pattern.png')}})">
              ...
              <a href="tel:+88123123456" class="body-1 contact-number hover-underline">+336 02 13 54 48</a>
    ...
    <div class="container">
      ...
      <div class="footer-top grid-list">
        ...
        <div class="footer-brand has-before has-after">
          ...
          <a href="#" class="logo">
            <img src="{{asset('./images/logo-best-restau.png')}}" width="160" height="50" loading="lazy" alt="best restau home">
          </a>
          ...
          <a href="mailto:contact@bestrestau.com" class="body-4 contact-link"> contact@bestrestau.com </a>

          <a href="tel:+88123123456" class="body-4 contact-link">Booking Request : +33-6 02 54 13 48</a>
      ...
      <div class="footer-bottom">
        ...
        <p class="copyright">
          &copy; 2023 Best Restau. All Rights Reserved | Crafted by <a href="https://github.com/IsmailLaghzil"
